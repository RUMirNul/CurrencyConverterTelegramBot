...
public enum BotMessageEnum {
    ...
    START_MESSAGE("Привет! Это Бот для *конвертации валюты*. Он поддерживает *160+* валют.\n" +
            ...
            "*\"" + ButtonNameEnum.HELP_BUTTON.getButtonName() + "\"*.\n"),
    HELP_MESSAGE("*Информация по работе с ботом*\n\n" +
            "*Доступные валюты*\n" +
            "Кнопка \"*" + ButtonNameEnum.ALL_CURRENCY_BUTTON.getButtonName() + "\"* покажет все доступные валюты.\n\n" +
            "*Конвертация валют\n*" +
    ...
    UNKNOWN_COMMAND_MESSAGE("*Неизвестная команда*\n" +
            "Используйте *\"" + ButtonNameEnum.HELP_BUTTON.getButtonName() + "\"* для получения доступных команд.\n"),
    ...
    EXCEPTION_NO_VALID_CURRENCY_CODE_MESSAGE("*Некоторые введённые вами валюты не поддерживаются!*\n" +
            "Используйте *\"" + ButtonNameEnum.ALL_CURRENCY_BUTTON.getButtonName() + "\"*, чтобы узнать все доступные" +
            " валюты.\n"),
    EXCEPTION_CURRENCY_INPUT_AMOUNT_MESSAGE("*Число для конвертации записано в неверном формате!*\n" +
            "Используйте *\"" + ButtonNameEnum.HELP_BUTTON.getButtonName() + "\"* для получения информации о записи числа.\n"),
